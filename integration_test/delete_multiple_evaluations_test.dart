...
void main() {
  ...
  group('[System Testing]: Delete Multiple Evaluations', () {
    /**
     * State
     */
    ...
    testWidgets(
        ...
        'When user delete two evaluations '
        'Then system should delete and show one evaluation', (tester) async {
      ...
      for (var i = 0; i < deleteNumbers; i++) {
        final cardKey = HistoryPageKeys.getEvaluationCardWDKey(i.toString());
        final evaCardWD = find.byKey(cardKey);
        expect(evaCardWD, findsOneWidget);

        await tester.tap(evaCardWD);
        await tester.pumpAndSettle();
        await Future.delayed(const Duration(milliseconds: 250));
      }
