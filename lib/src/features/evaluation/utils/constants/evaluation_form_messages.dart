class EvaluationFormMessages {
  ...
  static const fullBodyDescription =
      'Add a photo of your full body which contains\nwhole part of the body in the box below.';
  static const upperBodyTitle = 'Upper body';
  static const upperBodyDecription =
      'Add a photo of your current upper part of body\nwhich contains your face in the box below.';
  static const studentIdCardTitle = 'Student ID card';
  static const studentIdCardDescription =
      'Add a photo of your student id card which\ncontains your face and name in the box below.';
}
