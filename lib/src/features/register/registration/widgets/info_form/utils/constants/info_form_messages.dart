class InfoFormMessages {
  const InfoFormMessages._();

  static const instruction = 'Please fill in the following information.';
  static const userEmailTitle = 'User Email';
  static const emailFormPlaceholder = 'Email name';
