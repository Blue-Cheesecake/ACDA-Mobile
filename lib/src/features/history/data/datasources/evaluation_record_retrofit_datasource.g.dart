...
class _EvaluationRecordRetrofit implements EvaluationRecordRetrofit {
  ...
  Future<List<EvaluationRecordModel>> getRecords(params) async {
    ...
    final _result = await _dio.fetch<List<dynamic>>(_setStreamType<List<EvaluationRecordModel>>(Options(
      method: 'GET',
      headers: _headers,
      extra: _extra,
    )
    ...
    var value = _result.data!.map((dynamic i) => EvaluationRecordModel.fromJson(i as Map<String, dynamic>)).toList();
    return value;
  }
